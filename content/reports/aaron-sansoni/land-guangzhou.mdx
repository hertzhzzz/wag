...
Rand specializes in turnkey systems integration for theaters, performing arts venues, stadiums, luxury hotels, and smart buildings. The company has delivered projects including the Shanxi Grand Theatre (RMB 7.9 billion total investment), Foshan Cantonese Opera Theatre (35,000 sqm), and the Xingtai Workers' Cultural Palace (RMB 1.65 billion total investment). Core technical capabilities include stage lighting systems, stage machinery (truss/motors/rigging), drapes, and overall systems integration.
...
**Figure 3.** *Shanxi Grand Theatre (RMB 7.9B investment, 85,600 sqm, 1,628 seats) -- stage lighting system and control equipment by Rand Electronics.*
