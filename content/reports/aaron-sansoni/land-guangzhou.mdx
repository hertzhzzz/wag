...
| Unified Social Credit Code[^1] | 91440106565958101F | Verified through public corporate registry records and cross-referenced with commercial business intelligence records |
...
| Historical Name | Guangzhou Xiwangda Electronic Technology Co., Ltd. | Consistent with supplier-disclosed history: "acquired Guangzhou Baiyun Steinway Audio Equipment Factory in 2009" |
| Registered Address | Unit 501, Greenland Center, No. 662 Huangpu Avenue Middle, Tianhe District, Guangzhou | Verified |
| Company Type | Limited liability company; privately invested or controlled by natural persons[^7] | Verified |
...
| Insured Employees | Fewer than 50 (per public enterprise profile records) | Supplier-disclosed materials reference "50+ professional technical personnel" |
...
![Rand Business License & Qualifications](images/land-guangzhou-biz-license.png)
...
|---------------|-------|--------------|
| Professional Stage Audio Design, Installation & Commissioning | **Grade A**[^31] | Cross-verified (certification records + public industry directories + public enterprise profile records) |
...
**Figure 2.** *Rand Electronics four Grade-A stage technology qualifications issued by China Institute of Stage Design (CISD-201309-004): professional stage audio, audio-visual, lighting, and machinery design, installation and commissioning.*

![Rand Stage Grade A](images/land-guangzhou-stage-grade-a.png)

**Figure 3.** *Rand Electronics stage engineering qualifications: audio-visual integration (Advanced CAVE-ZZ2021-1853), professional stage audio Grade I, and professional stage lighting Grade I issued by China Association of Performing Arts.*

![Rand Stage Certs](images/land-guangzhou-stage-certs.png)
...
| Qualification | Grade | Verification |
|---------------|-------|--------------|
| Building Decoration & Finishing Professional Contracting | **Grade I** (Highest) | Public industry directories |
| Electronic & Intelligent Engineering Professional Contracting | Grade II | Supplier-disclosed materials |
| Construction Engineering General Contracting | Grade II | Supplier-disclosed materials |
| Urban & Road Lighting Engineering Professional Contracting | Grade II | Supplier-disclosed materials |
| Safety Production Permit | Active | Supplier-disclosed materials |

**Figure 4.** *Rand Electronics construction industry qualification certificates issued by Guangdong Provincial Department of Housing and Urban-Rural Development and Guangzhou Municipal Bureau of Housing and Urban-Rural Development.*

![Rand Construction Qualifications](images/land-guangzhou-construction-quals.png)

### 3.3 Management System Certifications

| Certification | Status | Verification |
|---------------|--------|--------------|
| ISO 9001 Quality Management[^9] | Confirmed | Cross-referenced through supplier-disclosed materials and public enterprise profile records |
...
| ISO 27001 Information Security Management | Confirmed | Supplier-disclosed materials |
| ISO 20000 Information Technology Service Management | Confirmed | Supplier-disclosed materials |

**Figure 5.** *Rand Electronics ISO 9001 quality management (02323Q20278R3M-A), ISO 14001 environmental management (02325E20161R2S-A), and ISO 45001 occupational health and safety (02325S20161R2S-A) certifications.*

![Rand ISO Trio](images/land-guangzhou-iso-trio.png)

**Figure 6.** *Rand Electronics ISO 20000 IT service management (Q282025ITSM325SR2CLMN) and ISO 27001 information security management (Q2825X10566R1S) certifications.*

![Rand IT & ISMS](images/land-guangzhou-it-isms.png)

### 3.4 Enterprise Designations

| Designation | Status | Verification |
|-------------|--------|--------------|
| National High-Tech Enterprise[^20] | Confirmed | Public credit information platform and enterprise profile records |
| SRDI SME[^21] | Confirmed | Credit Guangdong |
| Technology-Based SME[^29] | Confirmed | Public enterprise profile records |
| AAA Credit Rating Enterprise[^30] | Confirmed | Supplier-disclosed materials and public enterprise profile records |
| A-Level Taxpayer[^22] | Confirmed (3 consecutive years) | Supplier-disclosed materials and public enterprise profile records |
| Contract-Honoring & Credit-Worthy Enterprise[^23] | Confirmed (6 consecutive years) | Supplier-disclosed materials |

**Figure 7.** *Rand Electronics high-tech enterprise certificate (GR202344007689), Guangzhou S&T innovation small giant, enterprise R&D institution, and contract-honoring & credit-worthy enterprise (6 consecutive years 2015-2020).*

![Rand High-Tech & Patents](images/land-guangzhou-hightech-patents.png)
...
| Metric | Data | Notes |
|--------|------|-------|
| Total Employees | 50-99 | Public enterprise profile records. Supplier-disclosed materials reference "50+ professional technical personnel" |
...
Rand is a **systems integrator**, not an equipment manufacturer. The business model comprises four core functions:

| Function | Description |
|----------|-------------|
| Design | System design for audio, lighting, video, stage machinery, and acoustic requirements based on project specifications |
| Procurement | Equipment sourcing from proprietary brands (Noguang, ROKCOH) and third-party manufacturers |
| Integration | On-site installation, commissioning, and systems integration across all AVLC disciplines |
| After-Sales | Maintenance, training, warranty, and support services |

**Proprietary Brands:**
- Noguang - lighting products
...
**Figure 8.** *Rand Electronics corporate culture: positioning, philosophy, objectives, and mission statement.*

![Rand Corporate Culture](images/land-guangzhou-corporate-culture.jpeg)

### 4.4 Design Capability

According to supplier-disclosed materials, Rand provides:
...
- 3D renderings of completed designs (supplier materials reference "theater audience hall renderings")
...
| **Guigang Culture & Arts Center Grand Theatre** | Total investment RMB 705M, 115,300 sqm | Stage lighting, audio, video and intercom system installation & commissioning |
...
**Figure 9.** *Xingtai Workers' Cultural Palace -- total investment RMB 165M, 52,000 sqm, stage engineering and ELV/intelligent systems by Rand Electronics.*

![Rand Case Xingtai](images/land-guangzhou-case-xingtai.png)

**Figure 10.** *Shanxi Grand Theatre (RMB 790M investment, 85,600 sqm, 1,628 seats) -- stage lighting system and control equipment by Rand Electronics.*

![Rand Case Shanxi Theatre](images/land-guangzhou-case-theater-shanxi.jpeg)

**Figure 11.** *Machong Culture & Arts Center Theatre -- 1,100-seat multi-function theatre with stage engineering and ELV/intelligent systems for theatre, library, and broadcast facilities.*

![Rand Case Machong](images/land-guangzhou-case-machong.png)
...
**Figure 12.** *Jieyang Marriott Hotel -- 5,000+ sqm conference space, 25 meeting rooms, 1,818 sqm pillarless ballroom, AV system installation by Rand Electronics.*

![Rand Case Marriott](images/land-guangzhou-case-marriott.png)
...
### 5.6 Cultural Tourism & Landscape Lighting

**Figure 13.** *Cultural tourism and landscape lighting projects: Haishou Port immersive theater and Guidong County Botanical Garden.*
...
### 5.8 Project Statistics

**Figure 14.** *Guangzhou Yuexiushan Stadium -- 30,000 seats, historic 1950 venue, sound reinforcement system by Rand Electronics.*

![Rand Case Yuexiushan](images/land-guangzhou-case-yuexiushan.png)

**Figure 15.** *Rand Electronics construction quality and safety management: on-site construction details, project management process flowchart, and national standards compliance.*

![Rand Construction Quality](images/land-guangzhou-construction-quality.jpeg)

| Metric | Value | Source Type |
|--------|-------|-------------|
| Completed cases | 200+ | Supplier-disclosed |
| Bidding participations | 234+ | Public bidding / commercial intelligence records |
| Technical personnel | 50+ | Supplier-disclosed |
| Qualification certificates | 20+ | Supplier-disclosed / public qualification references |
...
Rand occupies a distinctive position in South China's stage technology integration market as a Grade-A-qualified specialist across all four stage technology disciplines. Unlike equipment manufacturers, Rand competes on integration capability, project delivery, and multi-disciplinary coordination.

| Market Indicator | Assessment |
|------------------|------------|
| Qualification Breadth | Four Grade-A stage professional qualifications[^31] covering audio, lighting, video, and machinery — a relatively uncommon combination in the industry |
| Project Portfolio | 200+ completed cases across theatres, luxury hotels, smart campuses, corporate facilities, cinemas, and sports venues |
| Bidding Track Record | 234+ bidding participations with no contract breach or dispute records identified |
| Client Calibre | Procter & Gamble, Hilton, Marriott, Wanda Cinemas, China Southern Power Grid |
| Geographic Reach | Projects across Guangdong, Guangxi, Hubei, Hunan, Shanxi, Jiangsu, and Hebei provinces |
| Credit Standing | A-Level Taxpayer[^22] (3 consecutive years); Contract-Honoring & Credit-Worthy Enterprise[^23] (6 consecutive years); AAA Credit Rating[^30] |

### 6.2 Competitive Positioning

As a systems integrator rather than an equipment manufacturer, Rand's value proposition differs from vertically integrated suppliers:

| Dimension | Rand's Model | Manufacturer-Integrators |
|-----------|-------------|--------------------------|
| Equipment | Multi-vendor sourcing; proprietary brands (Noguang, ROKCOH) for lighting and audio | Single-manufacturer product catalogue |
| Design Flexibility | Equipment selection optimised per project requirements, not constrained to in-house product lines | Design choices limited to own manufacturing catalogue |
| Project Scope | Full lifecycle: consultation → design → procurement → installation → commissioning → training → after-sales | Typically focused on supply + commissioning of own equipment |
| Scale | 50-99 employees; lean specialist team | Can range from small workshops to 1,000+ person operations |

This positioning makes Rand well-suited for projects requiring independent system design and multi-vendor integration, particularly for theatre, cultural venue, and luxury hotel applications where project-specific equipment selection is critical.

### 6.3 Industry Standing

- **China Entertainment Equipment Technology Association**[^34] — Council Member
- **China Stage Art Association** — Council Member; International Stage Art Organization China Center Group Council Member
- **Credit Guangdong**[^33] — Listed as "Trustworthy Incentive Target" with no adverse records
- **6 consecutive years** Contract-Honoring & Credit-Worthy Enterprise (2015-2020)
- ISO 9001 / 14001 / 45001 / 27001 / 20000 — five management system certifications
...
|-----------|----------|--------------|
| Paid-in Capital Ratio | Moderate | RMB 11.9M paid-in vs. RMB 51.8M registered (23%). This is common among Chinese private companies under subscribed-capital rules, but should be considered when assessing financial substance and contractual risk. |

### 7.2 Issues NOT Found

- No litigation records identified in reviewed public sources, including commercial intelligence records and credit information platforms
...
| After-Sales Service | Strong (Domestic) | 7x24 hotline, 15-min response, 1-hour on-site (domestic China). For cross-border delivery, the remote support model, spare parts process, and escalation pathway should be clarified. Monthly inspection routine, 3-guarantee policy (repair/replace/refund) during warranty. |
...
| Cooperation Willingness | Very Strong | As a smaller specialized integrator, Rand may place higher strategic value on international or cross-border cooperation opportunities, potentially supporting greater responsiveness than larger manufacturers. |
...
[^2]: **Commercial Business Intelligence Records:** Third-party business intelligence platforms in China aggregate public data from government registries and commercial databases. Equivalent to ASIC Connect + CreditorWatch combined. Used here for cross-verification of company registration details.
...
[^34]: **China Entertainment Equipment Technology Association / CETA (中国演艺设备技术协会):** China's primary industry association for the entertainment technology sector, covering professional audio, lighting, video, stage machinery, and related disciplines. CETA issues the Grade A/B/C stage professional qualification tiers referenced throughout this report. Council membership indicates recognised industry standing and participation in industry standards development.
