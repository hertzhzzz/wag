...
slug: "/article/modern-slavery-act-china-supplier-compliance-2026"
...
coverImageAlt: "Workers on a factory floor with production equipment — supply chain transparency"
takeaways:
...
Industries with labour-intensive production, complex supply chains, or seasonal demand patterns carry elevated risks. These include textiles and apparel, electronics assembly, footwear, toys, and agriculture. Our [china sourcing risks guide](/article/china-sourcing-risks) covers these categories in detail and how to manage them.
...
**Practical action:** Develop a simple risk matrix rating each supplier as high, medium, or low risk. Allocate your compliance resources accordingly. High-risk suppliers require direct engagement and verification; lower-risk suppliers may be managed through documentation and periodic review. Our [supplier verification checklist](/article/supplier-verification-checklist-china) provides the structured verification framework to assess each supplier.
...
**International audit firms**: [SGS](https://www.sgs.com), [Bureau Veritas](https://www.bureauveritas.com), Intertek, and [QIMA](https://www.qima.com) all operate in China with established audit methodologies. Costs typically range from AUD 500-2,000 per day depending on facility size and audit scope.

**Specialist modern slavery auditors**: Organisations like [Sedex](https://www.sedex.com), [amfori BSCI](https://www.amfori.org), and the [Fair Wear Foundation](https://www.fairwear.org) offer audit frameworks specifically designed to assess modern slavery and labour exploitation risks.
...
If you observe any of these indicators, stop the engagement pending further investigation. Document what you observed. Report to your compliance team. Consider whether the incident requires notification to authorities. For guidance on verifying suppliers before you engage them, see our [factory vs trading company guide](/article/factory-vs-trading-company-china-guide) which helps you understand who you are actually dealing with.
...
- [How to Verify a Chinese Supplier](/article/verify-chinese-supplier) — The complete verification framework
- [Factory vs Trading Company](/article/factory-vs-trading-company-china-guide) — Understanding who you are actually dealing with
- [Visiting Chinese Factories Checklist](/article/visiting-chinese-factories-australian-business-checklist) — Practical guide to factory visits
