...
<FloatImage src="https://images.unsplash.com/photo-1565514020176-db0a2c1e21d6?w=800&q=80" alt="Factory floor inspection with checklist" align="right" width={280} />
...
<FloatImage src="https://images.unsplash.com/photo-1581092160562-4aa729061f3d?w=800&q=80" alt="Manufacturing equipment on production floor" align="left" width={280} />
...
<FloatImage src="https://images.unsplash.com/photo-1524178232363-1fb2b0750f8e?w=800&q=80" alt="Business meeting and negotiation" align="right" width={280} />
...
<FloatImage src="https://images.unsplash.com/photo-1497366216548-3752607029d0?w=800&q=80" alt="Modern office environment" align="left" width={280} />
...
<FloatImage src="https://images.unsplash.com/photo-1565041666698-89c1bb6b2b38?w=800&q=80" alt="Active production line in a factory" align="right" width={280} />
...
### What questions should I ask during a factory visit in Guangzhou?

Ask about current production volume, machines on the floor, the last time they exported to Australia, and to meet the production manager directly. Ask to see QC records from recent production runs. If the supplier cannot produce documentation for recent export shipments, that is a warning sign.

### How do I check if a Chinese factory has export experience to Australia?

Ask specifically for documentation from recent Australian shipments. Check whether they understand Australian import requirements including any relevant certifications. Ask about customs clearance experience and whether they have had any shipments rejected.

### What is the biggest red flag when visiting a Chinese factory for the first time?

Refusal to show the production floor is the most serious red flag. A legitimate factory accommodating buyer visits is standard practice. If a supplier insists on showing only the showroom or conference room, they may not own the production facilities they claim to have.

### Should I visit factories in Shenzhen or Guangzhou for electronics procurement?

Both cities offer electronics manufacturing, but Shenzhen has a higher concentration of sophisticated manufacturers with export experience. Guangzhou factories tend to be more cost-competitive for larger volume orders. WAG can coordinate visits in both cities.

### How do I verify a Chinese supplier's business licence remotely?

Search the company on samr.gov.cn using the company name in Chinese or unified social credit code. Check the business scope for manufacturing, production, or processing terms. Verify the registered address matches an actual industrial location, not a commercial office building.

### What inspection services do you recommend for Australian buyers importing from China?

Third-party inspection services such as SGS, Bureau Veritas, or Asia Quality Focus can conduct pre-shipment inspections and production monitoring. Pre-shipment inspections typically cost $300-500 AUD depending on order size. For higher-value orders, consider mid-production inspections to catch problems before production is complete.