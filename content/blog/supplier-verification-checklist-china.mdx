...
slug: "/article/supplier-verification-checklist-china"
...
- Does the certificate number exist in the issuing body's database? You can verify ISO 9001 and other certifications directly through [iso.org](https://www.iso.org) or the issuing certification body.
...
**What this catches**: Expired certificates. Certificates belonging to different companies. Certificates that cover different product categories than what you are ordering. Fabricated certificates. Our [virtual factory audit guide](/article/virtual-factory-audit) covers the certification verification process in detail.
...
What to check:
- How many unrelated product categories does this supplier offer? More than three or four categories in different industries suggests aggregation from multiple factories. Our [factory vs trading company guide](/article/factory-vs-trading-company-china-guide) covers this in detail.
...
We conduct these audits for clients. An independent auditor spends one to two days at the facility and produces a written report with photographs. For ongoing procurement support beyond verification, see our [China sourcing agent service](/article/china-sourcing-agent).
...
- [How to Verify a Chinese Supplier](/article/verify-chinese-supplier) — The 6-step verification framework we use with every client
- [Visiting Chinese Factories Checklist](/article/visiting-chinese-factories-australian-business-checklist) — Complete planning guide for your China visit
- [How to Verify Chinese Factories on 1688](/article/how-to-verify-chinese-factories-1688) — Specific verification steps for 1688 suppliers
