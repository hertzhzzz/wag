...
slug: "/article/australia-china-sourcing-fraud-case-studies"
...
coverImageAlt: "Business owner reviewing supplier contracts and documents on a laptop at a desk"
takeaways:
...
Search the company on China's National Enterprise Credit Information Publicity System at [creditchina.gov.cn](https://www.creditchina.gov.cn). Verify the company name, unified social credit code, registered address, legal representative, and business scope. Confirm the business scope includes your product category. For a structured checklist covering this step and the five others that follow, see our [supplier verification checklist for Chinese factories](/article/supplier-verification-checklist-china).

**Step 2 — Physical address confirmation**

Use Google Maps or Baidu Maps to view the registered address. A factory should be in an industrial zone. If the address is in a commercial building or residential area, investigate further. Before paying any deposit, review our [supplier verification checklist](/article/supplier-verification-checklist-china) which covers this step in detail.

**Step 3 — Certification verification**

Verify every quality certification directly on the issuing body's website. Do not accept copies — check the registry directly. Cross-reference the certificate holder's name, address, and scope. For ISO 9001 certificates, verify through the [International Organization for Standardization](https://www.iso.org) or the issuing certification body directly. Our [virtual factory audit guide](/article/virtual-factory-audit) covers the full certification verification process in detail.

**Step 4 — Factory visit or pre-visit audit**

If you can travel, visit the factory in person before paying any significant deposit. If you cannot travel, arrange for a local inspection agent to conduct a half-day pre-visit audit (cost: approximately AUD 200-400). Our [visiting Chinese factories guide](/article/visiting-chinese-factories-guide) covers what to look for during a factory visit.
...
Place a small order of 10-50 units before committing to a large bulk order. This tests whether the supplier can actually produce and ship the product you require. For payment structure advice that protects your deposit, see our guide on [whether to pay a deposit to a Chinese supplier](/article/should-i-pay-deposit-chinese-supplier).
...
- [What Happens When Verification Is Skipped](/article/what-happens-when-verification-is-skipped) — The Caringbah case study in full
...
Yes. For any order above AUD 5,000, third-party inspection is strongly recommended. Inspection companies like [SGS](https://www.sgs.com), [Bureau Veritas](https://www.bureauveritas.com), [QIMA](https://www.qima.com), and Asian Inspection provide pre-shipment inspections and during-production inspections. Include inspection requirements in your purchase agreement so the supplier expects and accommodates it.
