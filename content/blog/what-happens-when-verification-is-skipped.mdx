...
A business license tells you what a company is legally authorised to do. If the business scope says "wholesale" and "export" rather than "manufacturing" and "production," you are dealing with a trading company, not a factory. See our [supplier verification checklist](/resources/supplier-verification-checklist-china) for the full step-by-step process.

This check takes 30 minutes and costs nothing. It can be done through China's National Enterprise Credit Information Publicity System (gsxt.gov.cn) using the supplier's registration number. Our [virtual factory audit guide](/resources/virtual-factory-audit) covers how to conduct this check remotely if you cannot travel.

### Step 2: Verify the address with satellite imagery

Factory addresses on supplier websites are sometimes incorrect. Plug the registered address into Google Maps or Baidu Maps before you do anything else. A factory that is supposed to be in an industrial zone but shows up as a commercial office building is a significant red flag. Our [factory vs trading company guide](/resources/factory-vs-trading-company-china-guide) explains what to look for and why the address check is so critical.
...
For Australian businesses that need ongoing support beyond single-verification engagements, our [China sourcing agent service](/resources/china-sourcing-agent) manages the full procurement cycle — from supplier shortlisting and factory visits through to quality coordination and logistics.
