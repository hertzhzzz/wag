...
slug: "/article/should-i-pay-deposit-chinese-supplier"
...
This structure exists because it protects both parties. The factory receives enough to cover raw material costs and begin production with some confidence the order will not be abandoned. The buyer retains most of the payment until they have evidence the order is proceeding correctly. For a full description of each verification step before you pay a deposit, see our [supplier verification checklist for Chinese factories](/article/supplier-verification-checklist-china).
...
Never pay 100% upfront on a first order. This is not a negotiation point. If a supplier insists, walk away. There is no legitimate reason a factory needs full payment before production starts that does not also create an unacceptable risk for you. Our article on [what happens when verification is skipped](/article/what-happens-when-verification-is-skipped) covers the real financial consequences of failing to verify before paying.
...
If the order requires tooling or mould setup, these are typically paid as a separate line item, often 50-100% upfront. This is standard practice because tooling costs are real and the supplier incurs them before production begins. The protection on tooling costs is typically: tooling is owned by the buyer after payment, and the supplier cannot use it for other orders without permission. See our [factory vs trading company guide](/article/factory-vs-trading-company-china-guide) for more on how to identify who you are actually dealing with before signing any tooling agreement.
...
Before you pay any deposit to a Chinese supplier, talk to us. We review the supplier's background, verify their registration, and advise on appropriate payment terms for your specific order. If you need ongoing procurement support, our [China sourcing agent service](/article/china-sourcing-agent) manages the full sourcing cycle — from supplier shortlisting through to shipment coordination. Our [virtual factory audit guide](/article/virtual-factory-audit) also covers how remote verification works if you cannot travel to China before committing.
...
- [What Happens When Verification Is Skipped](/article/what-happens-when-verification-is-skipped) — Why deposits get lost and how verification prevents it
- [Factory vs Trading Company](/article/factory-vs-trading-company-china-guide) — The signs that reveal whether you are dealing with a factory or intermediary
- [How to Negotiate with Chinese Factories](/article/how-to-negotiate-with-chinese-factory) — How payment terms fit into the broader negotiation
...
**What should I do if a supplier asks for a large deposit before seeing the factory?**

Walk away. A supplier who insists on a large deposit before you have verified their credentials — business license, address, production capability — is transferring all risk onto you. No legitimate factory requires this on a first order.

**How do I negotiate payment terms that protect both parties?**

Structure payments around inspection milestones rather than calendar dates. Standard: 30% on order confirmation, 40% after passing mid-production inspection, 30% after pre-shipment inspection and before shipment. This gives both parties incentives to perform correctly.
