...
|---|---|
| Platform | `chatgpt` |
| Run ID | `geo-sv-20260718-chatgpt-r1` |
| Captured as-of (manifest) | `2026-07-18T13:24:13.546Z` |
| Surface / account | ChatGPT free tier, signed-in test account; desktop; locale en-AU |
| Provenance | `external-platform-observation` |
| Claim mode | observation-only |
| Evidence root | `content/seo/geo/evidence/live/geo-sv-20260718-chatgpt-r1/` |
| Manifest | `content/seo/geo/evidence/live/geo-sv-20260718-chatgpt-r1/manifest.json` |
| Observations | `content/seo/geo/evidence/live/geo-sv-20260718-chatgpt-r1/observations/` (10 JSON) |
| Snapshots | `content/seo/geo/evidence/live/geo-sv-20260718-chatgpt-r1/snapshots/` |
| Capture log | `content/seo/geo/evidence/live/geo-sv-20260718-chatgpt-r1/capture-log.md` |
...
- Brand mention and owned URL citation were both 0/10 in this capture window.
