...
export default function SupplierVerificationContent() {
  const t = useT()

  const heroBullets = [
    t('page.sv.heroBullet1'),
    t('page.sv.heroBullet2'),
    t('page.sv.heroBullet3'),
  ]

  const stats = [
    { value: statValues[0], label: t('page.sv.statLabel1') },
    { value: statValues[1], label: t('page.sv.statLabel2') },
    { value: statValues[2], label: t('page.sv.statLabel3') },
    { value: statValues[3], label: t('page.sv.statLabel4') },
  ]

  const steps = [
    { icon: Building2, title: t('page.sv.step1Title'), body: t('page.sv.step1Body') },
    { icon: ClipboardCheck, title: t('page.sv.step2Title'), body: t('page.sv.step2Body') },
    { icon: ShieldCheck, title: t('page.sv.step3Title'), body: t('page.sv.step3Body') },
  ]

  const dataPoints = [
    t('page.sv.dataPoint1'),
    t('page.sv.dataPoint2'),
    t('page.sv.dataPoint3'),
  ]

  const categories = [
    t('page.sv.categoryElectronics'),
    t('page.sv.categoryMachinery'),
    t('page.sv.categoryVehicles'),
    t('page.sv.categoryFurniture'),
    t('page.sv.categoryApparel'),
  ]
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <ScrollReveal>
              <div className="border border-navy/10 p-6 h-full">
                ...
                <p className="font-serif font-bold text-navy text-2xl mb-2">{t('page.sv.riskStat1Value')}</p>
                <p className="text-navy/70 text-[15px] leading-relaxed">
                  {t('page.sv.riskStat1Body')}
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal>
              <div className="border border-navy/10 p-6 h-full">
                ...
                <p className="font-serif font-bold text-navy text-2xl mb-2">{t('page.sv.riskStat2Heading')}</p>
                <p className="text-navy/70 text-[15px] leading-relaxed">
                  {t('page.sv.riskStat2Body')}
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal>
              <div className="border border-navy/10 p-6 h-full">
                ...
                <p className="font-serif font-bold text-navy text-2xl mb-2">{t('page.sv.riskStat3Heading')}</p>
                <p className="text-navy/70 text-[15px] leading-relaxed">
                  {t('page.sv.riskStat3Body')}
                </p>
              </div>
            </ScrollReveal>
          </div>
            ...
            <ScrollReveal>
              <div className="bg-navy text-white p-8 md:p-10">
                ...
                <p className="font-serif font-bold text-2xl md:text-3xl mb-3 leading-snug">
                  {t('page.sv.dataCardHeading')}
                </p>
                <p className="text-white/75 leading-relaxed mb-6">
                  {t('page.sv.dataCardBody')}
                </p>
