        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="max-w-2xl mb-16">
            ...
            <p className="text-lg text-navy/60 mt-4 leading-relaxed">
              ...
              <Link href="/article/china-factory-tour-guide" className="text-navy underline hover:text-amber">China Factory Tour Guide</Link>.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 px-4 md:px-8 bg-[#f8f9fb]">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="mt-8 text-sm text-gray-500">
            ...
            <Link href="/article/supplier-verification-checklist-china" className="text-navy underline hover:text-amber">Supplier Verification Checklist</Link>.
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              { label: 'Brisbane China Sourcing', href: '/article/brisbane-china-factory-visits' },
              { label: 'China Sourcing Risks', href: '/article/china-sourcing-risks' },
              { label: '1688 Verification Guide', href: '/article/how-to-verify-chinese-factories-1688' },
