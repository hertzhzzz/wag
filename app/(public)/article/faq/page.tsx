...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.winningadventure.com.au/article/faq',
  },
  alternates: {
    canonical: 'https://www.winningadventure.com.au/article/faq',
  },
}
  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'FAQ', url: 'https://www.winningadventure.com.au/article/faq' }
      ]} />
