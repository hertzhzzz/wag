...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.winningadventure.com.au/article/china-sourcing-comparison',
    siteName: 'Winning Adventure Global',
    locale: 'en_AU',
  },
  alternates: {
    canonical: 'https://www.winningadventure.com.au/article/china-sourcing-comparison',
  },
}
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: 'China Sourcing Comparison', url: 'https://www.winningadventure.com.au/article/china-sourcing-comparison' },
      ]} />
      <Navbar />
