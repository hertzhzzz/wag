...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.winningadventure.com.au/article/china-sourcing-agent',
  },
}
  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'China Sourcing Agent', url: 'https://www.winningadventure.com.au/article/china-sourcing-agent' },
      ]} />
