  ...
  try {
    ...
    try {
      await transporter.sendMail({
        from: `"Winning Adventure Global Pty Ltd" <${process.env.GMAIL_USER}>`,
        to: email,
        subject: `We have received your message — Winning Adventure Global`,
        html: `
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#0F2D5E">
            <div style="background:#0F2D5E;padding:24px 32px;">
              <p style="color:#F59E0B;font-size:11px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;margin:0 0 4px">Message Received</p>
              <h1 style="color:#fff;font-size:22px;margin:0">Winning Adventure Global Pty Ltd</h1>
            </div>
            <div style="padding:32px;border:1px solid #e5e7eb;border-top:none;">
              <p style="font-size:15px;line-height:1.7;margin:0 0 16px;">Hi there,</p>
              <p style="font-size:15px;line-height:1.7;margin:0 0 16px;">Thank you for contacting Winning Adventure Global.</p>
              <p style="font-size:15px;line-height:1.7;margin:0 0 16px;">We have received your message and will get back to you <strong>within 4 hours</strong> during business hours (ACST, Mon–Fri).</p>
              <p style="font-size:15px;line-height:1.7;margin:0 0 24px;">If you have anything to add, simply reply to this email.</p>
