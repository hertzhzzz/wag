...
export const faqs = [
  ...
  {
    question: 'How long does a typical factory visit trip take?',
    answer: 'Most trips range from 3-7 days depending on your sourcing requirements. A typical factory tour programme includes 2-3 factory visits per day with sufficient time for questions and inspections.',
  },
  {
    question: 'What industries do you work with?',
    answer: 'We work across 50+ industries including manufacturing, technology, food and health, construction, property, agriculture, automotive, and packaging. Our network spans factories in Jiangsu, Zhejiang and Guangdong provinces.',
  },
  {
    question: 'Can you help with sample collection and quality inspection?',
    answer: 'Yes, we can coordinate sample collection during factory visits and arrange third-party quality inspections. We provide detailed quality assessment reports before you commit to bulk orders.',
  },
  {
    question: 'Do you offer ongoing support after the trip?',
    answer: 'Absolutely. We provide post-trip supplier comparison reports and remain available for ongoing communication with suppliers, order follow-up, and future sourcing needs.',
  },
  {
    question: 'What regions in China do you cover?',
    answer: 'Our operations cover major manufacturing hubs including Shenzhen, Foshan, Guangzhou, Zhengzhou, and Shaanxi. We have verified partners across 6 Chinese provinces.',
  },
  {
    question: 'How do you vet the factories you recommend?',
    answer: 'Every supplier in our network passes a 12-point verification process including business license verification, factory audits, quality management system review, and export history check.',
  },
  {
    question: 'What is the minimum order quantity you work with?',
    answer: 'We work with businesses of all sizes. Minimum order quantities vary by factory and product type. We will match you with suppliers appropriate for your volume requirements.',
  },
  {
    question: 'Can you help with shipping and logistics?',
    answer: 'Yes, we can arrange shipping quotes and logistics coordination. We work with established freight forwarders who handle documentation, customs clearance, and delivery to your specified address.',
  },
]
