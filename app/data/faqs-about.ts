// Company-specific FAQs for About page
// Different from homepage and services FAQs to avoid SEO duplication

export const aboutFaqs = [
  {
    question: 'Why was Winning Adventure Global founded?',
