...
export const metadata: Metadata = {
  ...
  keywords: ['china sourcing', 'china sourcing australia', 'adelaide china sourcing', 'south australia sourcing', 'australian import china', 'factory visit china', 'china sourcing adelaide', 'sourcing trip china', 'china factory tour', 'supplier verification china'],
  openGraph: {
    locale: 'en_AU',
