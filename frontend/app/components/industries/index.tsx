...
export default function Industries() {
  ...
  return (
    <section id="industries" className="bg-[#f0f4f8] py-[72px] px-4 md:px-10">
      ...
      {/* Featured panel - responsive: horizontal scroll on mobile, side-by-side on desktop */}
      <div className="max-w-[1100px] mx-auto mb-4">
        <div className="grid grid-cols-1 md:grid-cols-[260px_1fr] rounded-lg overflow-hidden shadow-[0_4px_24px_rgba(15,45,94,0.08)]">
          {/* Left sidebar - visible on desktop only */}
          <div className="hidden md:block bg-navy overflow-hidden">
          ...
          {/* Right panel - horizontal scroll on mobile, full width on desktop */}
          <div className="overflow-hidden">
            <FeaturedPanel industries={featured} activeIndex={activeIndex} isMobile={isMobile} />
          </div>
        </div>
      </div>
