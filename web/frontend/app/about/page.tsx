  ...
  return (
    <>
      ...
      <div className="py-10 md:py-[60px] px-4 md:px-[72px] max-w-[860px] mx-auto">
        ...
        <p className="text-base leading-relaxed text-gray-700 mb-5">
          Andy has spent years inside Chinese manufacturing hubs — Guangdong, Shenzhen, Foshan, Guangzhou, Zhengzhou, Shaanxi. He knows which suppliers deliver on time, which ones cut corners on quality, and which ones are genuinely excited to build long-term partnerships with Australian B2B buyers.
        </p>
